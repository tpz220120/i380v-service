...
public class SendMessage {
    ...
    private static String apikey = "beab221a8377aebb7923000932ea0a2c";
    private static String tplid = "2428882";

    public static void main(String[] args) throws IOException, URISyntaxException {
//    	double a = new Double("12");
//    	System.out.println(DOUBLE_FORMAT.format(a));
//    	System.out.println(new Double(DOUBLE_FORMAT.format(a)));
        //修改为您的apikey.apikey可在官网（http://www.yunpian.com)登录后获取
        String apikey = "e1ef9b420811bad7911549d71fb84176";

        //修改为您要发送的手机号
        String mobile = "15088648286";

        /**************** 查账户信息调用示例 *****************/
        //System.out.println(TestSendMessage.getUserInfo(apikey));
      ...
      //  String text = "【云片网】您的验证码是1234";
        ...
        System.out.println(SendMessage.tplSendSms("2233", mobile));
    ...
    */
    ...
    public static String tplSendSmsPsd(String passwd, String mobile) throws IOException {
   	 String tpl_value = URLEncoder.encode("#code#",ENCODING) +"="
   		        + URLEncoder.encode(passwd, ENCODING);
       Map<String, String> params = new HashMap<String, String>();
//       params.put("apikey", "e1ef9b420811bad7911549d71fb84176");
//       params.put("tpl_id", String.valueOf(1861372));
       params.put("apikey", apikey);
    ...
    public static String tplSendSms(String valcode, String mobile) throws IOException {
    	 String tpl_value = URLEncoder.encode("#code#",ENCODING) +"="
    		        + URLEncoder.encode(valcode, ENCODING);
        Map<String, String> params = new HashMap<String, String>();
        params.put("apikey", apikey);
        params.put("tpl_id", String.valueOf(0x160b3f));
        params.put("tpl_value", tpl_value);
        params.put("mobile", mobile);
        return post(URI_TPL_SEND_SMS, params);
    }
